  ...
  const temp = [
    {
      ...
      url: `/pages/common/newsList/index?id=${newsType.value.dongtai || ''}&title=${$t(
        'PavilionNews'
      )}`,
    },
    {
      id: 2,
      name: $t('PavilionIntroduction'),
      icon: `/static/index/${props.componentStyle}/activity.png`,
      url: `/pages/common/scenic/index`,
    },
    {
      id: 3,
      name: $t('PavilionPhotos'),
      icon: `/static/index/${props.componentStyle}/photo.png`,
      url: `/pages/common/photos/index?title=${$t('PavilionPhotos')}`,
    },
    {
      id: 4,
      name: $t('CulturalRelic'),
    ...
    },
    {
      ...
      url: `/pages/common/video/videoList`,
    },
    {
      id: 6,
      name: $t('Food'),
    ...
    },
    {
      ...
      url: `/pages/common/culture/index`,
    },
    {
      id: 8,
      name: $t('Hotel'),
