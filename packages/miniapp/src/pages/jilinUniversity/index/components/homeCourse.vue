<template>
  <view class="mt-40rpx w-full px-20rpx box-border">
    <view class="w-full flex justify-between items-center mb-30rpx">
      ...
      <view class="flex items-center">
        <view
          class="text-30 leading-42rpx font-400"
          @click="goTo('/pages/jilinUniversity/courseOnline/index?isTop=1')"
          >更多</view
        >
        <image
          src="https://pqntourism.pcleartv.cn/FtqAYKwuEun5pw4TuHXxBrKYJiN7"
          mode="scaleToFill"
