<template>
  <view class="mt-30rpx px-20rpx h-158 w-full box-border">
    ...
    >
      <image
        src="https://pqntourism.pcleartv.cn/FrhVb05lWVnemFrHb-0uL2Y3TGUo"
        mode="scaleToFill"
        class="w-100 h-100"
      />
      ...
      <image
        @click="goList"
        src="https://pqntourism.pcleartv.cn/FpPNX30sxfhKvBdB3natqFkXDy2K"
        mode="scaleToFill"
...
const goList = () => {
  uni.navigateTo({
    url: '/pages/szgbxy/notice/list',
  })
}
const handleClick = (item) => {
  uni.navigateTo({
    url: `/pages/szgbxy/notice/detail?id=${item.id}`,
  })
}
</script>
