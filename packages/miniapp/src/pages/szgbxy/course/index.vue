  ...
  <view class="w-full relative">
    ...
    <view class="flex w-full mb-20rpx">
      ...
      >
        <view
          ...
          :style="{ color: currentTab === index ? '#B10701' : '#000' }"
          >{{ item }}</view
        >
        <view
          v-if="currentTab === index"
          class="w-36 h-5 absolute bottom-14 translate-x--50% left-50% bg-#b10701"
        ></view>
      </view>
    </view>
    <!-- 简介详情 -->
      ...
      <view class="px-20rpx">
        ...
        <view class="mt-20rpx flex flex-wrap items-center">
          <view class="text-24 leading-40rpx tracking-1rpx mr-46rpx mb-10rpx yahei"
            >课程时长：<span class="text-#B10701">{{ (data?.duration / 60).toFixed(1) }}</span
            >分钟</view
          >
          <view class="text-24 leading-40rpx tracking-1rpx mr-46rpx mb-10rpx yahei"
          ...
          >
          <view class="text-24 leading-40rpx tracking-1rpx mr-46rpx mb-10rpx yahei"
            >报名人数：<span class="text-#B10701">{{ data?.actuallySignUpNum }}</span></view
          >
          <!-- <view class="text-24 leading-40rpx tracking-1rpx mr-46rpx mb-10rpx yahei"
        ...
        <view class="flex items-center mt-60rpx">
          <image
            src="https://pqntourism.pcleartv.cn/FvPzoqUzuVNy0bYqeN7_ovnR9a2f"
            mode="scaleToFill"
        ...
        <view class="w-full flex justify-between flex-wrap">
          ...
          >
            <view class="w-74 h-74 rounded-full">
              <image
                src="https://pqntourism.pcleartv.cn/Fof_J2QqL6N3nMxJvT7Q-_kEQGyR"
                mode="scaleToFill"
                class="w-full h-full"
              />
            </view>
    ...
    <view v-else>
      <view class="px-20rpx w-full box-border">
        ...
        <view class="flex items-center ml-14rpx">
          <view class="text-64 font-600 leading-90rpx text-#b10701">{{
          ...
          <view class="ml-30rpx">
            <view class="flex mb-14rpx">
              <image
                ...
                :key="index"
                src="https://pqntourism.pcleartv.cn/FkJdFHJtTtnTHeOEt9VBHUk0aVdE"
                mode="scaleToFill"
              ...
              >
                <view class="flex items-center">
                  <view
                    ...
                    :style="{
                      backgroundImage: `url(${
                        item.avatar || 'https://pqntourism.pcleartv.cn/FmVsOQTkf4VJ2CcQPwXOqSMdb_Z4'
                      })`,
                    }"
                  ></view>
        ...
        <view
          @click="handlePopup"
          class="fixed w-118 h-118 rounded-full right-40 bottom-158 flex flex-col justify-center items-center bg-#b10701"
        >
          <image
    ...
    <view class="fixed bottom-0 left-0 w-full h-90 flex bg-white">
      <view @click="collectOrNot" class="w-168 h-full flex flex-col justify-center items-center">
        <image
          :src="
            data.isCollected
              ? 'https://pqntourism.pcleartv.cn/FkJdFHJtTtnTHeOEt9VBHUk0aVdE'
        ...
        <view
          ...
          :style="{ color: data.isCollected ? '#b10701' : '' }"
          >{{ data.isCollected ? '已收藏' : '收藏' }}</view
        >
      </view>
      <view @click="signUp" class="flex-1 h-full flex justify-center items-center bg-#b10701">
    ...
    <uni-popup ref="popup" type="bottom" background-color="#fff">
      <view class="pt-60rpx pb-20rpx px-40rpx">
        ...
        <view @click="submit" class="w-full h-90 flex justify-center items-center bg-#b10701">
