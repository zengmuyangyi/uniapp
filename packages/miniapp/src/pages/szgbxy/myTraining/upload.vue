<template>
  <view class="w-full px-40rpx box-border">
    <view class="flex items-center mt-34rpx">
      <image
        src="https://pqntourism.pcleartv.cn/FvSLTElkExsbc1W0khKcjMa7Hv8g"
        mode="scaleToFill"
    ...
    <view class="w-full mt-37rpx">
      <view
        @click="chooseFile(1)"
        class="w-full h-300 border-2rpx border-solid flex flex-col justify-center items-center bg-#FFF3F3 border-#C30801"
      >
        <image
          src="https://pqntourism.pcleartv.cn/FoRGVcJyE_AIaqc0UeHjHxOJd2Ab"
          mode="scaleToFill"
          class="w-72 h-55 mb-45rpx"
        />
        <view class="w-571 text-center text-26 font-400 leading-40rpx tracking-1rpx text-#c30801"
    ...
    <view class="w-full mt-100rpx">
      <view
        ...
        :style="{
          backgroundColor: canLoad ? '#FFF3F3' : '#fff',
          borderColor: canLoad ? '#C30801' : '#BFBFBF',
        }"
      >
        <image
          :src="
            canLoad
              ? 'https://pqntourism.pcleartv.cn/FoRGVcJyE_AIaqc0UeHjHxOJd2Ab'
        ...
        <view
          ...
          :style="{ color: canLoad ? '#c30801' : '#BFBFBF' }"
