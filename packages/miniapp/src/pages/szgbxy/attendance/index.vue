<template>
  <view class="h-full">
    <view
      class="w-full h-full relative bg-no-repeat"
      style="
        background-image: url(https://pqntourism.pcleartv.cn/Fnncv1UNXiuzGdTzcgPCQaP6mInN);
        background-size: 295rpx 110rpx;
    ...
    >
      <view
        ...
        style="
          background-image: url(https://pqntourism.pcleartv.cn/FkSOKZY_T3mKC_d-_0MPoQ6ksfFP);
        ...
        <n-list :down="null" :up="null" height="screen-!80rpx" bg-type="none">
          <n-list-cell>
            <view class="w-full flex flex-col items-center">
              ...
              <view
                @click="handleClick"
                class="mt-50rpx w-330 h-330 flex justify-center items-center bg-cover bg-center"
                style="
                  background-image: url(https://pqntourism.pcleartv.cn/Fj17xdUl-ooFVxcap-Ra_hQC-CFj);
                "
              >
                <view
                  v-if="data?.isSignUp"
              ...
              <view class="mt-50rpx w-650">
                ...
                <view
                  ...
                  class="text-28 font-400 leading-72rpx tracking-2rpx text-#B10701"
                  >{{
                ...
                >
                <view v-else class="text-28 font-400 leading-72rpx tracking-2rpx text-#B10701"
                  >您未报名该课程</view
                >
              </view>
              <view @click="handleDetail" class="w-full flex justify-center mt-20rpx">
                <view class="w-300 h-80 flex justify-center items-center bg-#b10701">
...
const handleDetail = () => {
  uni.navigateTo({
    url: `/pages/szgbxy/myTraining/detail?id=${trainId.value}&showBack=1`,
  })
}
onLoad((options) => {
