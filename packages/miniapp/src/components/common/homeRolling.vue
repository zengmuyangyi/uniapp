<template>
  <div class="w-full z-999" :class="projectStyle[props.componentStyle]?.top || 'fixed bottom-0'">
    <div :class="props.componentStyle" class="w-full box-border">
      <view :class="props.componentStyle + '-inner'" class="w-full">
        ...
        <span v-else class="mr-2 text-size-30">{{ getText(rollingData.name) }}:</span>
